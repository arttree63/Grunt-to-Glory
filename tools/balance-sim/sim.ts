...
import { applyTick, buyMaxLevels, createInitialState, equip, forge, pendingMedals, salvage } from '../../src/core/game'
...
function run(medals: number, active = false, capMinutes = 180): RunResult {
  const s = createInitialState(medals, 0)
  let ms = 0
  let buyAcc = 0
  let lastBlockMs = 0
  let nextMark = 10
